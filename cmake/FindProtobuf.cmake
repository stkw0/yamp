...
#
# Generates Go sources from the .proto files
#
# protobuf_generate_go (<SRCS> <DEST> [<ARGN>...])
#
#  SRCS - variable to define with autogenerated source files
#  DEST - directory where the source files will be created
#  ARGN - .proto files
#
function(PROTOBUF_GENERATE_GO SRCS DEST)
  if(NOT ARGN)
    message(SEND_ERROR "Error: PROTOBUF_GENERATE_GO() called without any proto files")
    return()
  endif()

  if(PROTOBUF_GENERATE_GO_APPEND_PATH)
    # Create an include path for each file specified
    foreach(FIL ${ARGN})
      get_filename_component(ABS_FIL ${FIL} ABSOLUTE)
      get_filename_component(ABS_PATH ${ABS_FIL} PATH)
  ...
  foreach(FIL ${ARGN})
    ...
    list(APPEND ${SRCS} "${DEST}/${FIL_WE}.pb.go")
...
# By default have PROTOBUF_GENERATE_GO macro pass -I to protoc
# for each directory where a proto file is referenced.
if(NOT DEFINED PROTOBUF_GENERATE_GO_APPEND_PATH)
  set(PROTOBUF_GENERATE_GO_APPEND_PATH TRUE)
endif()
